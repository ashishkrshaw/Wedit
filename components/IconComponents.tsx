...
export const PhotoStackIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 7.125A2.25 2.25 0 0 1 4.5 4.875h15A2.25 2.25 0 0 1 21.75 7.125v10.5A2.25 2.25 0 0 1 19.5 19.875h-15A2.25 2.25 0 0 1 2.25 17.625v-10.5ZM12 15.75v-1.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 9.75v1.5M15 12.75h-1.5M15 12.75h1.5M9 12.75H7.5M9 12.75h1.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.204 6.75A2.25 2.25 0 0 1 4.5 5.625h15A2.25 2.25 0 0 1 20.796 6.75" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.204 18A2.25 2.25 0 0 0 4.5 19.125h15A2.25 2.25 0 0 0 20.796 18" />
  </svg>
);

export const WandIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.475 2.475-3 3 0 0 0 1.128 5.78A3 3 0 0 0 9.53 16.122ZM18.37 8.167a3 3 0 0 0-5.78-1.128 2.25 2.25 0 0 1-2.475-2.475-3 3 0 0 0-1.128-5.78A3 3 0 0 0 18.37 8.167Z" />
    </svg>
);
...
export const EyeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639l4.433-7.461a1.012 1.012 0 0 1 1.736 0l4.433 7.461a1.012 1.012 0 0 1 0 .639l-4.433 7.461a1.012 1.012 0 0 1-1.736 0l-4.433-7.461Z" />
